...
- **[Role Architecture](roles/README.md)** — One folder per role with industry job descriptions (where sourced), detailed instructions, routines, escalation paths, and agent-ready tasks.
